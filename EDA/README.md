...
- ✅ **Project Scope:** Build **3 analytical queries** that answered key questions about the data engineering job market
- ✅ **Data Modelling:** Used **multi-table joins** across the fact and dimensional tables
- ✅ **Analytics:** Applied **aggregations, filtering, and sorting** to find top skills by demand, salary, and overall value.
- ✅ **Outcomes:** Dilivered **actionable insights** on SQL and Python dominance, cloud trends, and salary patterns
