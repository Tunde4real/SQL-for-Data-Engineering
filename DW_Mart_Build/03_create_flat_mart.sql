...
CTAs is a perfect use case for flat marts, which justifies why it's used in here.
     No constraints, has it's own schema, supports fast incremental/updates,
...
-- CASCADE is used to ensure any table depending on schema is dropped
...
GROUP BY ALL;     -- Used because of the aggregation function ARRAY_AGG
